  ...
  Future<void> _openContact(String contact) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Cannot open contact")),
      );
    }
  }
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                          ...
                                          child: PageView(
                                            ...
                                            children: [
                                              if (device.frontImage != null)
                                                _buildImage(context, device, 0),

                                              if (device.backImage != null)
                                                _buildImage(context, device, 1),
                                            ],
                                          ),
                                        ),
                                    ...
                                    Wrap(
                                      ...
                                      runSpacing: 6,
                                      children:
                                          device.getTrustBadges().map((badge) {
